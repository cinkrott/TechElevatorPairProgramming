...
namespace TenmoClient
{
    public class AuthService
    {
        ...
        protected static IRestClient client = new RestClient();    // There is a reason that this is protected (not private)
                                                                   // and static. Oh, if you were only brave enought to ask.
