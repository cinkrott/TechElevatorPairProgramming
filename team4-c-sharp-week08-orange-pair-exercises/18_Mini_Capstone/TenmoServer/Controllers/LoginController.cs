...
namespace TenmoServer.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult Authenticate(LoginUser userParam)
        {
            // Default to bad username/password message
            ActionResult result = BadRequest(new { message = "Username or password is incorrect" });
        ...
        [HttpPost("register")]
        public ActionResult Register(LoginUser userParam)
        {
            ActionResult result;
