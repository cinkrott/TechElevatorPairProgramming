...
ALTER TABLE venue WITH CHECK ADD FOREIGN KEY (city_id) REFERENCES city(id)
ALTER TABLE space WITH CHECK ADD FOREIGN KEY (venue_id) REFERENCES venue(id)
ALTER TABLE city WITH CHECK ADD FOREIGN KEY (state_abbreviation) REFERENCES state(abbreviation)
ALTER TABLE category_venue WITH CHECK ADD FOREIGN KEY (venue_id) REFERENCES venue(id)
ALTER TABLE category_venue WITH CHECK ADD FOREIGN KEY (category_id) REFERENCES category(id)
ALTER TABLE reservation WITH CHECK ADD FOREIGN KEY (space_id) REFERENCES space(id)
...
--JOIN venue ON space.venue_id = venue.id
--JOIN reservation ON reservation.space_id = space.id
--WHERE ('2021-06-20' BETWEEN reservation.start_date AND reservation.end_date)
--OR ('2021-06-27' BETWEEN reservation.start_date AND reservation.end_date)
--OR ('2021-06-20' <= reservation.start_date AND reservation.end_date <= '2021-06-27')

SELECT * FROM reservation JOIN space ON reservation.space_id = space.id	WHERE space.venue_id = 8
