...
SELECT * FROM employee LEFT JOIN project_employee ON project_employee.employee_id = employee.employee_id
...
DELETE FROM project_employee WHERE project_id = 1 AND employee_id = 1;

SELECT MAX(department_id) AS 'max_id' FROM department

SELECT * FROM employee WHERE first_name LIKE '%e%' AND last_name LIKE '%i%'
